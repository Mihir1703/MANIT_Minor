...
original_dataset_path = '/home/mihir/Minor/Minor_project/raw_files/video/'
processed_dataset_path = '/home/mihir/Minor/Minor_project/processed_files/video/'

# Create video capture objects for the original and processed videos
data = os.listdir(original_dataset_path)
psnr_val = []
for i in data:
    original_cap = cv2.VideoCapture(original_dataset_path + i)
    processed_cap = cv2.VideoCapture(processed_dataset_path + i)
